  ...
  // home首页
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () =>
          import('@/views/Commerce/ProductionMarketingInformation.vue'),
      },
      {
      ...
      },
      {
        ...
        component: () =>
          import('@/views/PublicWelfare/PublicWelfareSwiper.vue'),
      },
      {
      ...
      },
      {
        ...
        component: () =>
          import('@/views/InformationSystem/AdminFarmArticle.vue'),
      },
      {
        path: '/information-system-admin-swiper',
        component: () =>
          import('@/views/InformationSystem/InformationAdminSwiper'),
      },
      {
        path: '/special-agricultural-products',
        component: () =>
          import('@/views/InformationSystem/SpecialAgriculturalProducts.vue'),
      },
      {
        path: '/business/directory',
        component: () =>
          import('@/views/InformationSystem/BusinessDirectory.vue'),
      },
      {
        path: '/complaint-advice',
        component: () =>
          import('@/views/InformationSystem/ComplaintAdvice.vue'),
      },
    ],
  },
];
